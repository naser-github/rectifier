# Task Execution Report: [Task number and name]
...
- Pricing registry entries used: [IDs or None]
- Usage evidence: [Runner, provider response, dashboard, invoice, or Unavailable]
- Usage unavailable reasons: [Execution IDs and reasons, or None]
